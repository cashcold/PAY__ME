...
import './style.css'
class GetStartMain extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
    render() { 
        return ( 
            <div className='get__start__main'>
                <section className='start__box__1'>
                    <h1>GET <span>STARTED</span></h1>
                    <h5>PayItForward Ltd crypto-trading and investment platform is designed for people without any experiense in trading and investment, so that everyone can ride the cryptocurrency revolution and achieve financial freedom and success. We have made everything – right from signup to growth and performance tracking – simple and effortless for our investors.</h5>
                </section>
                <section className='how__work how__work__getstart'>
                ...
                <section className='getRegister'>
                    <h3>JOIN PAYITFORWARD LTD AND DISCOVER THE TRUE POWER OF CRYPTOPTRADING</h3>
